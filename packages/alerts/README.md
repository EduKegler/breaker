...
Used by:
- **@breaker/router** — forwards formatted TradingView alerts
- **@breaker/exchange** — sends trade execution notifications
- **@breaker/refiner** — sends optimization session summaries
