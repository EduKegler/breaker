...
interface SupertrendAdxHighChandelierParams {
...
const DEFAULT_PARAMS: SupertrendAdxHighChandelierParams = {
  stPeriod: {
    value: 10,
    min: 7,
    max: 20,
  ...
  chandelierMult: {
    ...
    step: 0.5,
    optimizable: true,
    description: "Chandelier Exit ATR multiplier on 4H",
  },
  timeoutBars: {
    value: 120,
    min: 60,
...
export function createSupertrendAdxHighChandelier(
  ...
  return {
    name: "BTC 4H Trend Following — SuperTrend ADX Chandelier",
    params,
