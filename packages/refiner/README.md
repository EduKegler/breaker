...
Automated strategy optimization loop that uses Claude to iteratively improve trading strategy parameters and code, backed by the `@breaker/backtest` engine.
